...
|  **Felleskomponent** | **Modeller** | **Technical** / [.NET](https://docs.felleskomponent.no/net) |
|  ------ | ------ | ------ / [.NET](https://docs.felleskomponent.no/net) |
|  Personal | [Person](https://informasjonsmodell.felleskomponent.no/docs/felles_person) | [Java](https://docs.felleskomponent.no/java/fint-administrasjon-model-java) / [.NET](https://docs.felleskomponent.no/net) / [.NET](https://docs.felleskomponent.no/net) |
|           | [Personalressurs](https://informasjonsmodell.felleskomponent.no/docs/personal_personalressurs) | [Java](https://docs.felleskomponent.no/java/fint-administrasjon-model-java) / [.NET](https://docs.felleskomponent.no/net) / [.NET](https://docs.felleskomponent.no/net) |
|           | [Arbeidsforhold](https://informasjonsmodell.felleskomponent.no/docs/personal_arbeidsforhold) | [Java](https://docs.felleskomponent.no/java/fint-administrasjon-model-java) / [.NET](https://docs.felleskomponent.no/net) / [.NET](https://docs.felleskomponent.no/net) |
...
|  Lønnsmelding |  |  / [.NET](https://docs.felleskomponent.no/net) / [.NET](https://docs.felleskomponent.no/net) |
|  Variabel lønn |  |  / [.NET](https://docs.felleskomponent.no/net) / [.NET](https://docs.felleskomponent.no/net) |
|  Faktura |  |  / [.NET](https://docs.felleskomponent.no/net) / [.NET](https://docs.felleskomponent.no/net) |
